...
namespace Proyecto_Final_Cliente_Servidor_2023
{
    ...
    {
        string connectionString = "Data Source=DESKTOP-0P78FAK\\SQLEXPRESS;Initial Catalog=AreaServices;Integrated Security=True;";
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = " INSERT INTO [10.103.4.102].AreaServices.dbo.AreaType (nameArea , descriptionAreaType , status,idUserCreate ,creationDate) " +
                                   " VALUES (@nameArea , @descriptionAreaType , @status,@idUserCreate,@idUserCreate) ";
                    ...
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@creationDate",2023-12-08);
