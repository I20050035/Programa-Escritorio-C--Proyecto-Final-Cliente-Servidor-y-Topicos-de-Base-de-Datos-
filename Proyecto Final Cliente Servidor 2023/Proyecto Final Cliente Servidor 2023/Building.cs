...
namespace Proyecto_Final_Cliente_Servidor_2023
{
    ...
    {
        string connectionString = "Data Source=10.103.4.102;Initial Catalog=AreaServices;User ID=raquel; Password=123456;";
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "INSERT INTO [10.103.4.102].AreaServices.dbo.Building (number, descriptionBuilding, status)" +
